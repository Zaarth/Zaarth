...
**[Bank Reconciliation API](https://github.com/Zaarth/bank-reconciliation-api)** — Java 17 · Spring Boot · PostgreSQL · Docker · Testcontainers

A reconciliation system that matches bank statements against internal transactions using a matching engine with EXACT / PROBABLE / SUSPICIOUS tiers. 196 automated tests (unit + integration). Full REST API + server-rendered HTML interface.

---

## 📬 Contact

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/davidmundim)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:davidmundim@gmail.com)
